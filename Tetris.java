...
public class Tetris extends JPanel implements Runnable {
    ...
    void selectShape() {
        ...
        int min = 2;
        int max = 9;
        fallingShapeCol = (int)(Math.random()*((max-min)+1))+min;
    ...
    void drawStartScreen(Graphics2D g) {
        ...
        g.setFont(smallFont);
        g.drawString("Click Here To Start", clickX, clickY);
    }
    ...
    void drawUI(Graphics2D g) {
        ...
        g.setFont(smallFont);
        g.drawString(format("High score  %3d", scoreboard.getTopscore()), x, y);
        ...
        g.setFont(nameFont);
        g.drawString(format("By-Aditya    %6d", scoreboard.getScore()), x+90, y + 265);
